...
const newsData = [
  {
      image: "img/news1.jpg",
      title: "Sherubtse College Hosts Research Workshop and Guest Lecture on AI, Financial Literacy, and Socio-Political Theories",
      description: "Sherubtse College Hosts Insightful Talks on AI, Financial Literacy, and Socio-Political TheoriesOn September 30, 2024."
  },
  {
      image: "img/news2.png",
      title: "National Seminar Announcement: Bhutan’s Sustainable Development – A HolisticApproach",
      description: "A brief descriptiThis seminar aims to foster a national dialogue on achieving sustainable development through collaboration across diverse fields. We invite researchers,scholars, policymakers, and practitioners to explore the vital role of science,economics, sociology, and environmental stewardship in building a thriving future for Bhutan.on of the second news article goes here."
  },
  {
      image: "img/news3.jpeg",
      title: "Workshop on Symmetries, Data Science and AI for Physicist",
      description: "International Center for Theoretical Physics, Physics Without Frontiers working with the University of Sussex, and DISCnet are organising a 5-day intensive workshop in Symmetries, Data Science, and AI for Physicists for over 90 physics students of Sherubtse College."
  }
];
